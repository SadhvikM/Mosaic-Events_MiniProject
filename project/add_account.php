...
$error = '';
$id_q = "select max(user_id) as max_user_id from users;";
$user_id_q = $conn->query($id_q);
$res = $user_id_q->fetch_assoc();
$max_id = $res['max_user_id']+1;
...
if(isset($_POST['create']))
{
    ...
    else
    {
        ...
        {
            $sql2 = "insert into users(user_id,username,password,email_id,mobile_number) values('".$max_id."','".$username."','".$newpassword."','".$email_id."','".$mobile."')";
            $q2 = $conn->query($sql2);
